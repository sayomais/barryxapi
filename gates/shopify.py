    ...
    try:
        ...
        async def main():
            ...
            async with httpx.AsyncClient() as session:
                ...
                url="https://godless.com/cart/add.js"
                headers = {
            'authority': 'godless.com',
            'accept': 'application/json, text/javascript, */*; q=0.01',
            'accept-language': 'en-PK,en-GB;q=0.9,en-US;q=0.8,en;q=0.7',
            'content-type': 'application/x-www-form-urlencoded; charset=UTF-8',
            'origin': 'https://godless.com',
            'referer': 'https://godless.com/collections/the-drop-all-new-shit/products/demonic-porn-by-roman-neznayu',
            ...
            'utf8': '✓',
            'id': '41196671205509',
            'product-id': '7145754001541',
            'section-id': 'product',
        }
                
        
        
                request = await session.post(url=url, headers=headers, files=files)
                url = "https://godless.com/cart.js"
                headers = {
            ...
            'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.0.0 Mobile Safari/537.36',
                ...
                request = await session.get(url=url, headers=headers)
                token = request.json()["token"]
                url = "https://godless.com/cart"
                headers = {
            'authority': 'godless.com',
            ...
            'origin': 'https://godless.com',
            'referer': 'https://godless.com/cart',
            'sec-ch-ua': '"Chromium";v="137", "Not/A)Brand";v="24"',
            'sec-ch-ua-mobile': '?1',
            'sec-ch-ua-platform': '"Android"',
            ...
            'checkout': '',
                ...
                request = await session.post(url=url, headers=headers, data=data, follow_redirects=True)
                ...
                #print(x_checkout_one_session_token, queue_token, stable_id, paymentMethodIdentifier, sep=' | ')
                #4th Session Request
            ...
            'referer': 'https://checkout.pci.shopifyinc.com/build/d0a40b8/number-ltr.html?identifier=&locationURL=',
            'sec-ch-ua': '"Chromium";v="137", "Not/A)Brand";v="24"',
            'sec-ch-ua-mobile': '?1',
            'sec-ch-ua-platform': '"Android"',
            'sec-fetch-dest': 'empty',
            ...
            'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.0.0 Mobile Safari/537.36',
                ...
                json_data = {
            'credit_card': {
                'number': '4622 3910 9697 9169',
                'month': 2,
                'year': 2026,
                'verification_value': '163',
                'start_month': None,
                'start_year': None,
                'issue_number': '',
                'name': 'Say Barry',
            ...
            'payment_session_scope': 'godless.com',
                ...
                request = await session.post(url=url, headers=headers, json=json_data)
                sessionid = request.json()["id"]
                #5th Payment Request
                
                url = "https://godless.com/checkouts/unstable/graphql"
                headers = {
            'authority': 'godless.com',
            'accept': 'application/json',
            ...
            'variables': {
                        ...
                        'merchandiseLines': [
                            {
                                ...
                                'merchandise': {
                                    'productVariantReference': {
                                        'id': 'gid://shopify/ProductVariantMerchandise/41196671205509',
                                        'variantId': 'gid://shopify/ProductVariant/41196671205509',
                                        'properties': [],
                                        'sellingPlanId': None,
                ...
                'attemptToken': f'{token}-1tbtm976dr1h',
                'metafields': [],
                'analytics': {
                    'requestUrl': 'https://godless.com/checkouts/cn/{token}/?auto_redirect=false&edge_redirect=true&locale=en-US&skip_shop_pay=true',
                    'pageId': '9620a67a-BFFB-4541-91B7-2BC0279F5C6E',
                },
            },
            'operationName': 'SubmitForCompletion',
        }
                ...
                request = await session.post(url=url,
                params=params,
                headers=headers,
                json=json_data,
            )
            
                receiptid = request.json()["data"]["submitForCompletion"]['receipt']["id"]
                print(receiptid)
